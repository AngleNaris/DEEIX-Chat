...
func (m *Module) RegisterRoutes(authRequired *gin.RouterGroup) {
	...
	authRequired.GET("/conversation-roles", m.Handler.ListConversationRoles)
	authRequired.POST("/conversation-roles", m.Handler.CreateConversationRole)
	authRequired.POST("/conversation-roles/reorder", m.Handler.ReorderConversationRoles)
	authRequired.GET("/conversation-roles/:id", m.Handler.GetConversationRole)
	authRequired.PATCH("/conversation-roles/:id", m.Handler.UpdateConversationRole)
