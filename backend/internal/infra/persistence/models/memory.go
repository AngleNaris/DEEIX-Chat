...
type UserMemory struct {
	BaseModel
	UserID             uint   `gorm:"not null;index:idx_user_memories_user_id;uniqueIndex:idx_user_memories_user_key_v2,priority:1;comment:用户ID"`
	MemoryKey          string `gorm:"size:128;not null;uniqueIndex:idx_user_memories_user_key_v2,priority:2;comment:记忆键"`
