...
var exactErrorSpecs = map[string]errorSpec{
	...
	"agent group conversation constraints violated":           {Code: "conversation.agent_group_constraint_violated", Message: "agent group conversation constraints violated"},
	"agent group conversation project is immutable":           {Code: "conversation.agent_group_project_immutable", Message: "agent group conversation project is immutable"},
	"conversation role is in use by agent group member":       {Code: "conversation.agent_group_role_in_use", Message: "conversation role is in use by agent group member"},
	"conversation project is in use by agent group":           {Code: "conversation.agent_group_project_in_use", Message: "conversation project is in use by agent group"},
	"model override not allowed in agent group conversation":  {Code: "conversation.agent_group_model_override_rejected", Message: "model override not allowed in agent group conversation"},
	"conversation agent group not found":                      {Code: "conversation.agent_group_not_found", Message: "conversation agent group not found"},
	...
	"invalid mcp server description":  {Code: "mcp.invalid_server_description", Message: "invalid mcp server description"},
...
var fallbackMessages = map[string]string{
	...
	"conversation.agent_group_constraint_violated":      "agent group conversation constraints violated",
	"conversation.agent_group_project_immutable":        "agent group conversation project is immutable",
	"conversation.agent_group_role_in_use":              "conversation role is in use by agent group member",
	"conversation.agent_group_project_in_use":           "conversation project is in use by agent group",
	"conversation.agent_group_model_override_rejected":  "model override not allowed in agent group conversation",
	"conversation.agent_group_not_found":                "conversation agent group not found",
