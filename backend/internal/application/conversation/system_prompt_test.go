...
func TestResolveMessageSystemPromptInjectionUsesNativeSystemPrompt(t *testing.T) {
	...
	got := resolveMessageSystemPromptInjection(config.Config{DefaultSystemPrompt: "global rule"}, route, "project rule", false, systemPromptVars{})
	if got.Content == "" {
...
func TestResolveMessageSystemPromptInjectionOrdersProjectBeforeResponseFormat(t *testing.T) {
	...
	got := resolveMessageSystemPromptInjection(config.Config{}, route, "project rule", true, systemPromptVars{})
