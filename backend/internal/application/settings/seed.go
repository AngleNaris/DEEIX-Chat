...
const (
	...
	defaultAllowedMIMETypes       = "image/jpeg,image/png,image/webp,image/gif,audio/mpeg,audio/wav,audio/ogg,audio/mp4,audio/flac,audio/x-m4a,audio/x-wav,video/mp4,video/webm,text/plain,text/markdown,text/csv,text/yaml,application/json,application/yaml,application/x-yaml,application/toml,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel"
...
func defaultSettings() []domainsettings.SystemSetting {
	return []domainsettings.SystemSetting{
		...
		{Namespace: "chat", Key: "multimodal_delegation_enabled", Value: "false", ValueType: "bool", Description: "为不支持媒体输入的主模型启用系统级多模态模型委派"},
		{Namespace: "chat", Key: "multimodal_delegation_model", Value: "", ValueType: "string", Description: "旧版系统级多模态委派模型；仅在对应媒体类型未单独配置模型时回退使用"},
		{Namespace: "chat", Key: "multimodal_delegation_image_model", Value: "", ValueType: "string", Description: "系统级图片理解委派使用的聊天模型"},
		{Namespace: "chat", Key: "multimodal_delegation_audio_model", Value: "", ValueType: "string", Description: "系统级音频理解委派使用的聊天模型"},
		{Namespace: "chat", Key: "multimodal_delegation_video_model", Value: "", ValueType: "string", Description: "系统级视频理解委派使用的聊天模型"},
		{Namespace: "chat", Key: "multimodal_delegation_modalities", Value: "image,audio,video", ValueType: "string", Description: "允许委派的媒体类型，逗号分隔：image,audio,video"},
		{Namespace: "chat", Key: "multimodal_delegation_timeout_seconds", Value: "120", ValueType: "int", Description: "系统级多模态分析超时秒数"},
