...
const THEME_PRESET_PREVIEWS: ThemePresetPreview[] = [
  ...
  },
  {
    ...
    light: {
      background: "oklch(1.0000 0 0)",
      sidebar: "oklch(0.9840 0.0060 295.0000)",
      sidebarBorder: "oklch(0.8400 0.0080 295.0000)",
      surface: "oklch(1.0000 0 0)",
      surfaceBorder: "oklch(0.8000 0.0100 295.0000)",
      textStrong: "oklch(0.2500 0.0120 295.0000)",
      textSoft: "oklch(0.5400 0.0220 295.0000)",
      accent: "oklch(0.5500 0.2100 295.0000)",
    },
    dark: {
      background: "oklch(0.2300 0.0120 295.0000)",
      sidebar: "oklch(0.2100 0.0100 295.0000)",
      sidebarBorder: "oklch(0.4000 0.0100 295.0000)",
      surface: "oklch(0.2700 0.0140 295.0000)",
      surfaceBorder: "oklch(0.4400 0.0120 295.0000)",
      textStrong: "oklch(0.9400 0.0080 295.0000)",
      textSoft: "oklch(0.7200 0.0120 295.0000)",
      accent: "oklch(0.7800 0.1450 295.0000)",
    },
  },
  {
    label: "Graphite",
